...
contract StarNotary is ERC721 {
   ...
   constructor()  ERC721("Crypto LuvicuStar", "CLV") {}
   // Star data
    struct Star {
        string name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerOf(_tokenId1)==msg.sender || ownerOf(_tokenId2)==msg.sender), "The Sender must be the owner of the token");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId)== msg.sender, "The sender must be the owner of the token");
